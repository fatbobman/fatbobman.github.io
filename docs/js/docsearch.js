...
!(function (e, t) {
  ...
  function P(e) {
    ((!e.__d && (e.__d = !0) && f.push(e) && !I.__r++) || m !== s.debounceRendering) &&
  ...
  function D(e, t, n, r, o, i, c, a, u, l) {
    ...
    for (n.__k = [], s = 0; s < t.length; s++)
      if (
        ...
        if (((m.__ = n), (m.__b = n.__b + 1), null === (p = g[s]) || (p && m.key == p.key && m.type === p.type)))
          g[s] = void 0;
        else
          for (f = 0; f < _; f++) {
        ...
        q(e, m, (p = p || d), o, i, c, a, u, l),
          (v = m.__e),
          (f = m.ref) && p.ref != f && (b || (b = []), p.ref && b.push(p.ref, null, m), b.push(f, m.__c || v, m)),
          null != v
            ? (null == y && (y = v),
    ...
    for (n.__e = y, s = _; s--; )
      null != g[s] &&
        ('function' == typeof n.type && null != g[s].__e && g[s].__e == n.__d && (n.__d = w(r, s + 1)), U(g[s], g[s]));
    if (b) for (s = 0; s < b.length; s++) H(b[s], b[++s], b[++s]);
  }
  function k(e, t, n) {
    var r, o;
    for (r = 0; r < e.__k.length; r++)
      (o = e.__k[r]) && ((o.__ = e), (t = 'function' == typeof o.type ? k(o, t, n) : C(n, o, o, e.__k, o.__e, t)));
    return t;
  }
  function A(e, t) {
    return (
  ...
  function C(e, t, n, r, o, i) {
    ...
    if (void 0 !== t.__d) (c = t.__d), (t.__d = void 0);
      ...
      e: if (null == i || i.parentNode !== e) e.appendChild(o), (c = null);
        ...
        for (a = i, u = 0; (a = a.nextSibling) && u < r.length; u += 2) if (a == o) break e;
      ...
      e: if ('function' == typeof w) {
        if (
          ...
          null != w.getDerivedStateFromProps &&
            (f.__s == f.state && (f.__s = b({}, f.__s)), b(f.__s, w.getDerivedStateFromProps(y, f.__s))),
          (m = f.props),
          (v = f.state),
          p)
        )
          null == w.getDerivedStateFromProps && null != f.componentWillMount && f.componentWillMount(),
          ...
          if (
            (null == w.getDerivedStateFromProps &&
              ...
              f.componentWillReceiveProps(y, _),
            (!f.__e && null != f.shouldComponentUpdate && !1 === f.shouldComponentUpdate(y, f.__s, _)) ||
              t.__v === n.__v)
          ) {
            (f.props = y),
              (f.state = f.__s),
        ...
        null == i && t.__v === n.__v ? ((t.__k = n.__k), (t.__e = n.__e)) : (t.__e = M(n.__e, t, n, r, o, i, c, u));
      (l = s.diffed) && l(t);
    } catch (e) {
  ...
  function M(e, t, n, r, o, i, c, a) {
    ...
    if (null === v) p === m || (a && e.data === m) || (e.data = m);
      ...
      if (
        ...
        (s || l) &&
          ((s && ((l && s.__html == l.__html) || s.__html === e.innerHTML)) || (e.innerHTML = (s && s.__html) || ''));
      }
      if (
        ((function (e, t, n, r, o) {
          var i;
  ...
  function B(e, t, n) {
    ...
    s.__ && s.__(e, t),
      ...
      q(
        t,
        (e = ((!r && n) || t).__k = _(S, null, [e])),
        o || d,
        d,
        void 0 !== t.ownerSVGElement,
        !r && n ? [n] : o ? null : t.firstChild ? h.slice.call(t.childNodes) : null,
        i,
  ...
  ((de.prototype = new j()).isPureReactComponent = !0),
    ...
    (t.componentWillUnmount = function () {
      ...
      e.__v
        ? (t.l ||
          ...
          B(_(Ee, { context: t.context }, e.__v), t.l))
        : t.l && t.componentWillUnmount();
  }
  function Ie(e, t) {
    return _(Pe, { __v: e, i: t });
  }
  ...
  s.vnode = function (e) {
    ...
    if ('string' == typeof t) {
          ...
          ('defaultValue' === o && 'value' in n && null == n.value
            ...
            : 'download' === o && !0 === i
              ...
              : /ondoubleclick/i.test(o)
                ? (o = 'ondblclick')
                : /^onchange(textarea|input)/i.test(o + t) && !Ae(n.type)
                  ? (o = 'oninput')
      ...
      'select' == t &&
        ...
        (r.value = A(n.children).forEach(function (e) {
  ...
  var Ye = Be.forwardRef(function (e, t) {
    ...
    return (
      ...
      Be.createElement(
        'button',
        ze({ type: 'button', className: 'DocSearch DocSearch-Button', 'aria-label': u }, o, { ref: t }),
        Be.createElement(
          'span',
          { className: 'DocSearch-Button-Container' },
          Be.createElement(We, null),
          Be.createElement('span', { className: 'DocSearch-Button-Placeholder' }, c)
        ),
        Be.createElement(
          'span',
          ...
          null !== s &&
            Be.createElement(
              Be.Fragment,
              null,
              Be.createElement('kbd', { className: 'DocSearch-Button-Key' }, s === Ze ? Be.createElement(Ve, null) : s),
              Be.createElement('kbd', { className: 'DocSearch-Button-Key' }, 'K')
            )
        )
      )
    );
  ...
  var ot = function () {};
  var it = [{ segment: 'autocomplete-core', version: '1.9.3' }];
  function ct(e) {
    var t = e.item,
      n = e.items;
    return {
  ...
  function bt(e) {
    for (
      ...
      n.push(ht(ht({}, e), {}, { objectIDs: e.objectIDs.slice(r, r + t) }));
    return n;
  }
  function gt(e) {
  ...
  function _t(e) {
    var t,
      ...
      r,
      o =
        ((t = at((e.version || '').split('.').map(Number), 2)),
        (n = t[0]),
        (r = t[1]),
    ...
    function i(t, n, r) {
      if (o && void 0 !== r) {
        var i = r[0].__autocomplete_algoliaCredentials,
          c = { 'X-Algolia-Application-Id': i.appId, 'X-Algolia-API-Key': i.apiKey };
        e.apply(void 0, [t].concat(pt(n), [{ headers: c }]));
  ...
  var kt = '2.6.0',
    ...
    Ct = Ge(function (e) {
      ...
      t({
        insights: r,
        insightsEvents: Ot({ items: n }).map(function (e) {
          return It({ eventName: 'Items Viewed' }, e);
        }),
        state: o,
      });
    }, 400);
    ...
    var a = _t(c),
      ...
      l = Ge(function (e) {
        ...
        if (t.isOpen) {
          ...
          ) || ((u.current = n), n.length > 0 && Ct({ onItemsChange: r, items: n, insights: a, state: t }));
        }
      }, 0);
    return {
      ...
      subscribe: function (e) {
        ...
        c('addAlgoliaAgent', 'insights-plugin'),
          t({ algoliaInsightsPlugin: { __algoliaSearchParameters: { clickAnalytics: !0 }, insights: a } }),
          n(function (e) {
            var t = e.item,
              n = e.state,
              r = e.event;
            St(t) &&
              o({
                ...
                insights: a,
                item: t,
                insightsEvents: [It({ eventName: 'Item Selected' }, ct({ item: t, items: u.current }))],
              });
          }),
          r(function (e) {
            var t = e.item,
            ...
            St(t) &&
              i({
                ...
                insights: a,
                item: t,
                insightsEvents: [It({ eventName: 'Item Active' }, ct({ item: t, items: u.current }))],
              });
          });
      },
  ...
  function Tt(e) {
    return Nt(e, { isCanceled: !1, onCancelList: [] });
  }
  function Rt(e, t, n) {
    return e
      ? function (n) {
  ...
  function zt(e, t, n) {
    ...
    return {
      ...
      dispatch: function (r, i) {
        ...
        (o = e(o, { type: r, props: t, payload: i })), n({ state: o, prevState: c });
      },
      pendingRequests:
        ((r = []),
        {
      ...
      return fn(
        ...
        {},
        {
          requests: e.queries.map(function (n) {
            return {
              query: 'algolia' === e.requesterId ? fn(fn({}, n), {}, { params: fn(fn({}, r), n.params) }) : n,
              sourceId: t,
  ...
  function An(e) {
    ...
    if ((f(i), p(o.defaultActiveItemId), !i && !1 === o.openOnFocus)) {
      ...
      m('idle'), l(d), s(null !== (v = r.isOpen) && void 0 !== v ? v : o.shouldPanelOpen({ state: a.getState() }));
      var h = Tt(
        kn(d).then(function () {
    ...
    m('loading'),
      (Dn = o.environment.setTimeout(function () {
        m('stalled');
      }, o.stallThreshold));
    var y = Tt(
      kn(
        o.getSources(Sn({ query: i, refresh: c, state: a.getState() }, u)).then(function (e) {
          return Promise.all(
            e.map(function (e) {
              return Promise.resolve(e.getItems(Sn({ query: i, refresh: c, state: a.getState() }, u))).then(
                function (t) {
            ...
            .then(function (e) {
              return (function (e) {
                ...
                return Xe(n.reshape({ sourcesBySourceId: i, sources: Object.values(i), state: r }))
                  .filter(Boolean)
                  .map(function (e) {
      ...
      .then(function (e) {
        ...
        if (null !== a.getState().activeItemId && p) {
          var v = p.item,
            ...
            y = p.source;
          y.onActive(
            Sn({ event: t, item: v, itemInputValue: d, itemUrl: h, refresh: c, source: y, state: a.getState() }, u)
          );
        }
      })
      .finally(function () {
    ...
    return {
        ...
        return zn(
          {
            ...
            onSubmit: function (i) {
              var c;
              i.preventDefault(),
                t.onSubmit(zn({ event: i, refresh: n, state: r.getState() }, o)),
            ...
            onReset: function (i) {
              var c;
              i.preventDefault(),
                t.onReset(zn({ event: i, refresh: n, state: r.getState() }, o)),
      ...
      getLabelProps: function (e) {
        var n = e || {},
          r = n.sourceIndex,
          o = $n(n, Bn);
        return zn({ htmlFor: ''.concat(i(t.id, r), '-input'), id: ''.concat(i(t.id, r), '-label') }, o);
      },
      getInputProps: function (e) {
        ...
        function c(e) {
          (t.openOnFocus || Boolean(r.getState().query)) &&
            An(
              zn({ event: e, props: t, query: r.getState().completion || r.getState().query, refresh: n, store: r }, o)
            ),
        ...
        return zn(
          {
            ...
            type: 'search',
            onChange: function (e) {
              An(zn({ event: e, props: t, query: e.currentTarget.value.slice(0, l), refresh: n, store: r }, o));
            },
            onKeyDown: function (e) {
                ...
                if ('ArrowUp' === t.key || 'ArrowDown' === t.key) {
                  ...
                  t.preventDefault(),
                    !1 === o.getState().isOpen && (n.openOnFocus || Boolean(o.getState().query))
                      ? An(Tn({ event: t, props: n, query: o.getState().query, refresh: r, store: o }, i)).then(
                          function () {
                            o.dispatch(t.key, { nextActiveItemId: n.defaultActiveItemId }), a(), setTimeout(c, 0);
                          }
                        )
                  ...
                  if (t.metaKey || t.ctrlKey)
                    void 0 !== f &&
                      ...
                      n.navigator.navigateNewTab({ itemUrl: f, item: l, state: o.getState() }));
                  else if (t.shiftKey)
                    void 0 !== f &&
                      (p.onSelect(
                        Tn(
                      ...
                      n.navigator.navigateNewWindow({ itemUrl: f, item: l, state: o.getState() }));
                  else if (t.altKey);
                  else {
                    if (void 0 !== f)
                      return (
                        ...
                        void n.navigator.navigate({ itemUrl: f, item: l, state: o.getState() })
                      );
                    An(Tn({ event: t, nextState: { isOpen: !1 }, props: n, query: s, refresh: r, store: o }, i)).then(
                      function () {
                        p.onSelect(
                          Tn(
                            {
              ...
              })(zn({ event: e, props: t, refresh: n, store: r }, o));
            },
            onFocus: c,
            onBlur: ot,
            onClick: function (n) {
      ...
      getListProps: function (e) {
        var n = e || {},
          ...
          o = $n(n, Vn);
        return zn(
          { role: 'listbox', 'aria-labelledby': ''.concat(i(t.id, r), '-label'), id: ''.concat(i(t.id, r), '-list') },
          o
        );
      },
        ...
        return zn(
          {
            ...
            onMouseMove: function (e) {
              if (c.__autocomplete_id !== r.getState().activeItemId) {
                ...
                if (null !== r.getState().activeItemId && t) {
                  ...
                  l.onActive(
                    zn(
                      { event: e, item: i, itemInputValue: a, itemUrl: u, refresh: n, source: l, state: r.getState() },
                      o
                    )
                  );
                }
            ...
            onClick: function (e) {
              ...
              (u
                ? Promise.resolve()
                : An(zn({ event: e, nextState: { isOpen: !1 }, props: t, query: i, refresh: n, store: r }, o))
              ).then(function () {
                a.onSelect(
                  zn(
                    { event: e, item: c, itemInputValue: i, itemUrl: u, refresh: n, source: a, state: r.getState() },
                    o
                  )
                );
              });
  ...
  function er(e) {
    var t,
      ...
      c = e.options,
      a =
        null === (t = ((null === (n = c.__autocomplete_metadata) || void 0 === n ? void 0 : n.userAgents) || [])[0]) ||
        void 0 === t
          ? void 0
          : t.segment,
      u = a
        ? Xn({}, a, Object.keys((null === (r = c.__autocomplete_metadata) || void 0 === r ? void 0 : r.options) || {}))
        : {};
    return {
      plugins: i.map(function (e) {
        return { name: e.name, options: Object.keys(e.__autocomplete_pluginOptions || []) };
      }),
      options: Gn({ 'autocomplete-core': Object.keys(c) }, u),
  ...
  function tr(e) {
    ...
    return !1 === n.isOpen || null === n.activeItemId
      ? null
      : (null === (t = Ft(n)) || void 0 === t ? void 0 : t.itemInputValue) || null;
  }
  function nr(e) {
    return (
      (nr =
  ...
  var cr = function (e, t) {
    switch (t.type) {
      ...
      case 'mousemove':
        return or(or({}, e), {}, { activeItemId: t.payload });
      case 'setQuery':
        return or(or({}, e), {}, { query: t.payload, completion: null });
      case 'setCollections':
        return or(or({}, e), {}, { collections: t.payload });
      case 'setIsOpen':
        return or(or({}, e), {}, { isOpen: t.payload });
      case 'setStatus':
        return or(or({}, e), {}, { status: t.payload });
      case 'setContext':
        return or(or({}, e), {}, { context: or(or({}, e.context), t.payload) });
      case 'ArrowDown':
        var n = or(
          or({}, e),
          {},
          {
            activeItemId: t.payload.hasOwnProperty('nextActiveItemId')
              ...
              : qt(1, e.activeItemId, tt(e), t.props.defaultActiveItemId),
          }
        );
        return or(or({}, n), {}, { completion: tr({ state: n }) });
      case 'ArrowUp':
        var r = or(or({}, e), {}, { activeItemId: qt(-1, e.activeItemId, tt(e), t.props.defaultActiveItemId) });
        return or(or({}, r), {}, { completion: tr({ state: r }) });
      case 'Escape':
        return e.isOpen
          ? or(or({}, e), {}, { activeItemId: null, isOpen: !1, completion: null })
          : or(or({}, e), {}, { activeItemId: null, query: '', status: 'idle', collections: [] });
      case 'submit':
        return or(or({}, e), {}, { activeItemId: null, isOpen: !1, status: 'idle' });
      case 'reset':
        return or(
          or({}, e),
          {},
      ...
      case 'blur':
        return t.props.debug ? e : or(or({}, e), {}, { isOpen: !1, activeItemId: null });
      case 'mouseleave':
        return or(or({}, e), {}, { activeItemId: t.props.defaultActiveItemId });
      default:
  ...
  function fr(e) {
    var t = [],
      ...
      r = zt(cr, n, function (e) {
        var t = e.prevState,
          r = e.state;
        n.onStateChange(lr({ prevState: t, state: r, refresh: c, navigator: n.navigator }, o));
      }),
      o = (function (e) {
        var t = e.store;
        return {
                ...
                return Qt(
                  ...
                  {},
                  {
                    items: Xe(e.items).map(function (e) {
                      return Qt(Qt({}, e), {}, { __autocomplete_id: n++ });
                    }),
                  }
                );
              });
      ...
      i = Qn(lr({ props: n, refresh: c, store: r, navigator: n.navigator }, o));
    function c() {
      return An(
        lr(
          {
    ...
    return (
      ...
      })({ metadata: er({ plugins: n.plugins, options: e }), environment: n.environment }),
      lr(lr({ refresh: c, navigator: n.navigator }, i), o)
    );
  }
  function pr(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement(
          'defs',
          null,
          Be.createElement('style', null, '.cls-1,.cls-2{fill:#003dff;}.cls-2{fill-rule:evenodd;}')
        ),
        Be.createElement('path', {
          className: 'cls-2',
  ...
  function vr(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement(pr, { translations: { searchByText: b } })
      ),
      Be.createElement(
        'ul',
        ...
        Be.createElement(
          ...
          Be.createElement(
            ...
            Be.createElement(
              mr,
              { ariaLabel: c },
              Be.createElement('path', { d: 'M12 3.53088v3c0 1-1 2-2 2H4M7 11.53088l-3-3 3-3' })
            )
          ),
        ...
        Be.createElement(
          ...
          Be.createElement(
            'kbd',
            { className: 'DocSearch-Commands-Key' },
            Be.createElement(mr, { ariaLabel: p }, Be.createElement('path', { d: 'M7.5 3.5v8M10.5 8.5l-3 3-3-3' }))
          ),
          Be.createElement(
            'kbd',
            { className: 'DocSearch-Commands-Key' },
            Be.createElement(mr, { ariaLabel: s }, Be.createElement('path', { d: 'M7.5 11.5v-8M10.5 6.5l-3-3-3 3' }))
          ),
        ...
        Be.createElement(
          ...
          Be.createElement('span', { className: 'DocSearch-Label' }, v)
        )
      )
    );
  }
    ...
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement('circle', { strokeOpacity: '.3', cx: '18', cy: '18', r: '18' }),
          Be.createElement(
            'path',
  ...
  function yr() {
    return Be.createElement(
      ...
      Be.createElement(
        ...
        Be.createElement('path', { d: 'M3.18 6.6a8.23 8.23 0 1112.93 9.94h0a8.23 8.23 0 01-11.63 0' }),
        Be.createElement('path', { d: 'M6.44 7.25H2.55V3.36M10.45 6v5.6M10.45 11.6L13 13' })
      )
    );
  }
  function br() {
  ...
  function Ir(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement('div', { className: 'DocSearch-Screen-Icon' }, Be.createElement(Er, null)),
  ...
  function xr(e) {
    ...
    return Be.createElement(
      ...
      Be.createElement('div', { className: 'DocSearch-Screen-Icon' }, Be.createElement(Pr, null)),
      Be.createElement(
        'p',
  ...
  function Hr(e) {
    ...
    return _(
      ...
      Rr(
        Rr({}, Lr(e, Nr)),
        {},
        { dangerouslySetInnerHTML: { __html: Mr(t, '_snippetResult.'.concat(n, '.value')) || Mr(t, n) } }
      )
    );
  }
  function Ur(e, t) {
      ...
      ? Be.createElement(
          ...
          Be.createElement(
            ...
            e.collection.items.map(function (t, n) {
              return Be.createElement(Wr, Br({ key: [e.title, t.objectID].join(':'), item: t, index: n }, e));
            })
          )
        )
      : null;
        ...
        Be.createElement(
          ...
          t.hierarchy[t.type] &&
            ...
            Be.createElement(
              ...
              Be.createElement(Hr, { className: 'DocSearch-Hit-title', hit: t, attribute: 'hierarchy.lvl1' }),
              t.content && Be.createElement(Hr, { className: 'DocSearch-Hit-path', hit: t, attribute: 'content' })
            ),
          t.hierarchy[t.type] &&
            ...
            Be.createElement(
              ...
              Be.createElement(Hr, { className: 'DocSearch-Hit-path', hit: t, attribute: 'hierarchy.lvl1' })
            ),
          'content' === t.type &&
            Be.createElement(
              'div',
              { className: 'DocSearch-Hit-content-wrapper' },
              Be.createElement(Hr, { className: 'DocSearch-Hit-title', hit: t, attribute: 'content' }),
              Be.createElement(Hr, { className: 'DocSearch-Hit-path', hit: t, attribute: 'hierarchy.lvl1' })
            ),
          o({
            item: t,
    ...
    var o = (
      (r.__docsearch_parent
        ? null === (t = r.__docsearch_parent) ||
          ...
          ? void 0
          : t.lvl0
        : null === (n = e._highlightResult) || void 0 === n || null === (n = n.hierarchy) || void 0 === n
          ? void 0
          : n.lvl0) || {}
    ).value;
                ...
                r.__docsearch_parent &&
                  Be.createElement(
                    ...
                    Be.createElement(
                      ...
                      r.__docsearch_parent !==
                        (null === (n = t.items[o + 1]) || void 0 === n ? void 0 : n.__docsearch_parent)
                        ? Be.createElement('path', { d: 'M8 6v21M20 27H8.3' })
                        : Be.createElement('path', { d: 'M8 6v42M20 27H8.3' })
                    )
                  ),
                Be.createElement('div', { className: 'DocSearch-Hit-icon' }, Be.createElement(Or, { type: r.type }))
              );
            },
            renderAction: function () {
              return Be.createElement('div', { className: 'DocSearch-Hit-action' }, Be.createElement(gr, null));
            },
          })
        );
      }),
        ...
        : Be.createElement(
            ...
            Be.createElement(
              ...
              to({}, r, {
                ...
                renderIcon: function () {
                  return Be.createElement('div', { className: 'DocSearch-Hit-icon' }, Be.createElement(yr, null));
                },
  ...
  var ao = Be.memo(
      function (e) {
        ...
        if ('error' === r.state.status)
          return Be.createElement(Ir, { translations: null == n ? void 0 : n.errorScreen });
        var o = r.state.collections.some(function (e) {
          return e.items.length > 0;
        });
        return r.state.query
          ? !1 === o
            ? Be.createElement(xr, io({}, r, { translations: null == n ? void 0 : n.noResultsScreen }))
            : Be.createElement(Xr, r)
          : Be.createElement(ro, io({}, r, { hasCollections: o, translations: null == n ? void 0 : n.startScreen }));
      },
      function (e, t) {
    ...
    return (
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement(
            'label',
            lo({ className: 'DocSearch-MagnifierLabel' }, r.getLabelProps()),
            Be.createElement(We, null)
          ),
          Be.createElement('div', { className: 'DocSearch-LoadingIndicator' }, Be.createElement(hr, null)),
          Be.createElement(
            'input',
            lo(
          ...
          Be.createElement(
            'button',
            { type: 'reset', title: i, className: 'DocSearch-Reset', 'aria-label': a, hidden: !r.state.query },
            Be.createElement(br, null)
          )
        ),
        Be.createElement(
          'button',
          { className: 'DocSearch-Cancel', type: 'reset', 'aria-label': f, onClick: r.onClose },
          l
        )
      )
    );
    ...
    return {
      ...
      set: function (e, t) {
        return Promise.resolve().then(function () {
          var i = o();
          return (
            (i[JSON.stringify(e)] = { timestamp: new Date().getTime(), value: t }), r().setItem(n, JSON.stringify(i)), t
          );
        });
      },
      delete: function (e) {
      ...
      : {
          get: function (e, r) {
            ...
            return n.get(e, r, o).catch(function () {
              return go({ caches: t }).get(e, r, o);
            });
          },
          set: function (e, r) {
            return n.set(e, r).catch(function () {
              return go({ caches: t }).set(e, r);
            });
          },
          delete: function (e) {
            return n.delete(e).catch(function () {
              return go({ caches: t }).delete(e);
            });
          },
          clear: function () {
            return n.clear().catch(function () {
              return go({ caches: t }).clear();
            });
          },
        };
  }
  ...
  var wo = '4.19.1',
    Eo = { WithinQueryParameters: 0, WithinHeaders: 1 };
  function Po(e, t) {
    var n = e || {},
      r = n.data || {};
    return (
  ...
  function No(e) {
    return 'string' == typeof e
      ? { protocol: 'https', url: e, accept: Io.Any }
      : { protocol: e.protocol || 'https', url: e.url, accept: e.accept || Io.Any };
  }
  var To = 'GET',
    Ro = 'POST';
  function qo(e, t) {
          ...
          d = {
            ...
            onRetry: function (r) {
              ...
              return (
                r.isTimedOut && p++,
                Promise.all([
                  e.logger.info('Retryable failure', Bo(o)),
                  e.hostsCache.set(s, xo(s, r.isTimedOut ? Ao : ko)),
                ]).then(function () {
                  return t(n, a);
                })
              );
  ...
  var Vo = function (e) {
        ...
        o = (function (e) {
          ...
          t(
            t(
              {
                hosts: [
                  { url: ''.concat(n, '-dsn.algolia.net'), accept: Io.Read },
                  { url: ''.concat(n, '.algolia.net'), accept: Io.Write },
                ].concat(
                  Oo([
            ...
            {},
            {
              headers: t(t(t({}, r.headers()), { 'content-type': 'application/x-www-form-urlencoded' }), e.headers),
    ...
    zo = function (e) {
      return function (n, r) {
        var o = n.map(function (e) {
          return t(t({}, e), {}, { params: Uo(e.params || {}) });
        });
        return e.transporter.read({ method: Ro, path: '1/indexes/*/queries', data: { requests: o }, cacheable: !0 }, r);
      };
    },
    Jo = function (e) {
      return function (n, r) {
        return Promise.all(
          n.map(function (n) {
            var o = n.params,
              ...
              a = o.facetQuery,
              u = i(o, yo);
            return Ko(e)(n.indexName, { methods: { searchForFacetValues: Zo } }).searchForFacetValues(
              c,
              a,
              t(t({}, r), u)
            );
    ...
    Qo = function (e) {
      return function (t, n) {
        return e.transporter.read(
          { method: Ro, path: jo('1/indexes/%s/query', e.indexName), data: { query: t }, cacheable: !0 },
          n
        );
      };
    },
  ...
  function ei(e, n, r) {
    var o,
      i = {
              ...
              (n.onreadystatechange = function () {
                ...
                (n.onerror = function () {
                  0 === n.status &&
                    (clearTimeout(i),
                    clearTimeout(r),
                    t({ content: n.responseText || 'Network request failed', status: n.status, isTimedOut: !1 }));
                }),
                (n.onload = function () {
                  clearTimeout(i), clearTimeout(r), t({ content: n.responseText, status: n.status, isTimedOut: !1 });
                }),
                n.send(e.data);
            });
          },
        ...
        responsesCache: _o(),
        requestsCache: _o({ serializable: !1 }),
        hostsCache: go({ caches: [bo({ key: ''.concat(wo, '-').concat(e) }), _o()] }),
        userAgent: Mo(wo).add({ segment: 'Browser', version: 'lite' }),
        ...
        {},
        {
          methods: {
            ...
            initIndex: function (e) {
              return function (t) {
                return Ko(e)(t, { methods: { search: Qo, searchForFacetValues: Zo, findAnswers: $o } });
              };
            },
          },
        }
  ...
  function si(e) {
    var t = e.appId,
      ...
      W = (function (e, t, n) {
        return Be.useMemo(
          function () {
            var r = ei(e, t);
            return (
              r.addAlgoliaAgent('docsearch', ti),
              !1 === /docsearch.js \(.*\)/.test(r.transporter.userAgent.value) &&
                r.addAlgoliaAgent('docsearch-react', ti),
              n(r)
            );
          },
          [e, t, n]
      ...
      K = Be.useRef(ho({ key: '__DOCSEARCH_FAVORITE_SEARCHES__'.concat(r), limit: 10 })).current,
      z = Be.useRef(
        ho({ key: '__DOCSEARCH_RECENT_SEARCHES__'.concat(r), limit: 0 === K.getAll().length ? 7 : 4 })
      ).current,
      J = Be.useCallback(
        function (e) {
          if (!S) {
                  ...
                  return (
                    p &&
                      (v = {
                        ...
                        __autocomplete_algoliaCredentials: { appId: t, apiKey: n },
                      }),
                          ...
                          return Object.values(
                            ...
                            .map(function (e) {
                              return e.map(function (t) {
                                ...
                                return (
                                  'lvl1' !== t.type && r && (n = r), ii(ii({}, t), {}, { __docsearch_parent: n }, v)
                                );
                              });
                            })
                            .flat();
    ...
    return (
          ...
          function () {
            if (n && r && o) {
              ...
              return (
                ...
                function () {
                  window.removeEventListener('touchstart', i), window.removeEventListener('touchmove', c);
                }
              );
            }
          },
      ...
      })({ getEnvironmentProps: Z, panelElement: H.current, formElement: M.current, inputElement: U.current }),
      (function (e) {
        var t = e.container;
        Be.useEffect(
          function () {
      ...
      Be.createElement(
        ...
        Be.createElement(
          ...
          Be.createElement('footer', { className: 'DocSearch-Footer' }, Be.createElement(vr, { translations: A }))
        )
      )
    );
  }
        ...
        Be.useEffect(
          function () {
            function e(e) {
              var c;
              ((27 === e.keyCode && t) ||
                ('k' === (null === (c = e.key) || void 0 === c ? void 0 : c.toLowerCase()) &&
                  (e.metaKey || e.ctrlKey)) ||
                (!(function (e) {
                  var t = e.target,
                    n = t.tagName;
